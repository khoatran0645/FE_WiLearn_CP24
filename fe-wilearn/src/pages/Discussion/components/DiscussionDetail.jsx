...
import { Paper, Typography, TextareaAutosize, Button, Grid, Avatar } from '@mui/material';
  ...
  return (
    <Grid>
      <Grid sx={{ border: '1px solid #ccc', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', maxWidth:'900px',margin: '20px auto 0' }}>
        <Grid sx={{ background: '#f8f8f8', padding: '20px', borderBottom: '1px solid #ccc'}}>
            <Grid>
              <Typography variant="h6" style={{ color: '#333', marginRight: '10px', textAlign:"center" }}>Tại sao chọn .NET?</Typography>
            </Grid>
            <Grid sx={{display: 'flex'}}>
                <Avatar alt="Minia Doe" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcST2mXZyjeEgVKZ4yOV5SS2dL5UC10y0RRCew&usqp=CAU" sx={{ marginRight: '10px' }} />
                <Typography variant="body1" style={{ fontSize: '16px', color: '#888', margin: '5px 0' }}>Minia Doe</Typography>              
            </Grid>
            <Typography variant="body1" style={{ fontSize: '16px', color: '#888', margin: '5px 0' }}>March 17, 2024 10:00 AM</Typography>
        </Grid>
        <Paper sx={{ padding: '20px' }}>
          ...
          />
          <Typography variant="body1" style={{ fontSize: '14px', textAlign: 'justify' }}>
