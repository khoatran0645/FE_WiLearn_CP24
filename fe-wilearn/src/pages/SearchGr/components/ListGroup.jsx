      ...
      <Grid container justifyContent="center" paddingTop={2}>
        {groups.map((group, index) => (
          <Grid item key={index} xs={12} sm={6} md={4} lg={3}>
            <Card style={{ maxWidth: 250, height:'260px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '10px', border: '1px solid' }}>
              <CardHeader 
              ...
              />
              <CardContent style={{ height: '70px', paddingTop: '8px', overflow: 'auto' }}>
                <Typography variant="body2" color="textSecondary" component="p" fontSize="14px">
                  {group.introduction}
                </Typography>          
              </CardContent>
              <Grid container justifyContent="center">
