...
export const REMOVE_ALL_PEERS = 'ADD_VOTING';
...
export const removeAllPeerAction = () => ({
  type: REMOVE_ALL_PEERS,
});

export const addAllPeersActions = (peers) => ({
  type: ADD_ALL_PEERS,
  payload: { peers }
});

// export const addVotingAction = (voting) => ({
//   type: ADD_VOTING,
//   payload: { voting }
// });
