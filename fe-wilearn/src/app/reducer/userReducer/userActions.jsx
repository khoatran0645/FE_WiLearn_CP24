...
import { API_GET_USER_INFO, API_GOOGLE_SIGNIN_URL, API_SIGNIN_URL, API_SIGNUP_URL } from '../../../constants';
...
export const checkLoginGoogle = createAsyncThunk('auth/login', async (access_token, { rejectWithValue }) => {
  // Call API checkLogin
  return await axiosClient
