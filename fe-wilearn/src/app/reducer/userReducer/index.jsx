...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getPersonalStatistics.pending, (state) => {
      state.loading = true;
      state.error = null;
    });
    builder.addCase(getPersonalStatistics.fulfilled, (state, { payload }) => {
      state.loading = false;
      state.statsData = payload;
    });
    builder.addCase(getPersonalStatistics.rejected, (state, { payload }) => {
      state.loading = false;
      state.error = payload;
    });

    // get more user stats
    builder.addCase(getMoreUserStats.pending, (state) => {
      state.loading = true;
      state.error = null;
    });
    builder.addCase(getMoreUserStats.fulfilled, (state, { payload }) => {
      state.loading = false;
      state.moreUserStats = payload;
    });
    builder.addCase(getMoreUserStats.rejected, (state, { payload }) => {
      state.loading = false;
      state.error = payload;
    });
  },
...
export { checkLogin, register, getUserInfo, getUsermMeetings, resetPassword, getPersonalStatistics, getMoreUserStats }; // export asynchronous actions
